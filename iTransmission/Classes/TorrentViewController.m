...
@synthesize bandwidthController = fBandwidthController;
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    if ((self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil])) {
        ...
        self.normalToolbarItems = [NSArray arrayWithObjects:addButton, flexSpaceOne, refreshButton, flexSpaceTwo, flexSpaceThree, prefButton, nil];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSLog(@"Should delete torrent %s", [torrent name]);
}
...
{
	if (self.bandwidthController.visible) {
		[self.bandwidthController hide];
	}
	else {
		[self.bandwidthController showFromToolbar:self.navigationController.toolbar];
	}
}

- (void)infoButtonClicked:(id)sender
{
	[[[[UIAlertView alloc] initWithTitle:@"Info" message:@"This is an alpha release. Please check out http://code.google.com/p/itransmission for more info. " delegate:nil cancelButtonTitle:@"Dismiss" otherButtonTitles:nil] autorelease] show];
}
...
- (void)viewDidLoad {
	...
	self.bandwidthController = [[BandwidthController alloc] initWithTorrent:nil];
}
